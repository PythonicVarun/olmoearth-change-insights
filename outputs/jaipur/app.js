    ...
    const [summary, overlay, boundary, wardOverlay, waybackConfig] = await Promise.all([
        ...
        (async () => {
            try {
                ...
                const overlayUrl = "https://proxy.pythonicvarun.me/https://github.com/PythonicVarun/olmoearth-change-insights/releases/download/assets-2026-06-12/jaipur-overlay.pmtiles";
